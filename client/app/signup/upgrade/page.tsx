'use client'
import signUp, { signUpAnonymous, signUpGoogleUpgrade } from '@/firebase/auth/signup';
...
export default function Page() {
    ...
    async function handleGoogleSignInUpgrade() {
        const { result, error } = await signUpGoogleUpgrade();
        ...
        <div className="flex h-screen flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <div className="flex items-center justify-center bg-gray-100 mt-5">
                    <button onClick={handleGoogleSignInUpgrade} type='button' className="flex flex-grow justify-center items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
